These are all the files and documents related to win shares that are created by the code (although when running the code they appear in the same directory as the data set).
